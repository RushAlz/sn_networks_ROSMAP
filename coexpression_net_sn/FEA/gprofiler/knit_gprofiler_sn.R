...
git_dir = "/pastel/Github_scripts/SpeakEasy_dlpfc/sn_dlpfc/2nd_pass/FEA/gprofiler/"
...
render_report = function(element_list){
  rmarkdown::render(
    paste0(git_dir, "gprofiler_base_glia_neurons_sn.Rmd"), params = list(
      cell_type=element_list # cell_type comes from the Rmd params. element_list is what changes. 
    ),
    output_file = paste0(git_dir, "Report_gprofiler_cl4_", element_list, ".html")
  )
}
