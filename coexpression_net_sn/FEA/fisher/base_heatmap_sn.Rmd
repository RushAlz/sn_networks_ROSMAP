...
# paste(net_output$gene_name[net_output$cluster_lv3 == 19], collapse = " ")
```
...
```{r}
gene_cluster_enrich$module_id = paste0(macro_type, "_m", gene_cluster_enrich$module_id)
createDT(gene_cluster_enrich)
```
